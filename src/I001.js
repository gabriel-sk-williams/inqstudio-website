  ...
  renderEssay = () => {
    return (
      <div className="appear grid-break">
        ...
        <br/><br/>
        Some years earlier in 1989, the term Industrial Ecology was coined to identify a new science dedicated to sustainability, accounting for the many interlocking systems (factories, energy, transportation) that were central to the emerging dilemma of global warming. The science of 'sustainability,'' however, suffers from many of the same issues as classical ecology. There is mounting evidence that sustainability is 1) widely misunderstood, conceptually, and 2) incapable of being implemented to high standards of execution. Creating a perfectly sustainable system is the modern-day myth of a perpetual motion machine; a great Gordian Knot for the Information Age.
        <br/><br/>
