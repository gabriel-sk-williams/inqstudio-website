  ...
  description = () => {
    return (
      <div className="appear grid-break">
        <h3>inq is an interdisciplinary studio based in New York City, specializing in the development of products and services on the frontier of sustainability, design, and urbanism.</h3><br/><br/>
        ...
        <h3>we specialize in cities and their infrastructures, bringing a deep wealth of practical, historical, and theoretical knowledge to bear on issues of housing, transport, access, and land-use.</h3><br/>
