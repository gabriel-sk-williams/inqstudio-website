  ...
  renderEssay = () => {
    return (
      <div className="appear grid-break">
        <h3>
        As a continuation of <Link to='003'>our last essay</Link>, I hereby present <i>The Olympics of Weights and Measures</i>, where the world's remaining measurement systems compete for dominance on the world stage. The metric system may be great for science and post-feudal taxation, but there are numerous contexts where the use of alternative units is a regular benefit! The best units are, in fact, context-dependent: what is really being compared, and why is that comparison valuable? How much does the system need to scale, and at what level of granularity, to be most convenient for users who need to communicate useful information quickly and efficiently? Sometimes, there is a "best unit."
        <br/><br/>
