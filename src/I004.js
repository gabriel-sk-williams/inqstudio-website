  ...
  renderEssay = () => {
    return (
      <div className="appear grid-break">
        ...
        <br/>
        Meters were developed with no regard for human proportion—the height of a person might be 1.78 meters, and the height of a room closer to 2.5. The width of a doorway? That'll be point-eight meters, thank you. The metric system absolutely suffers at the human scale, which is why metric users will describe their height in centimeters. Still—180 centimeters is a bizarre level of granularity for height, and decimeters aren't much better: the difference between 17 and 18 decimeters in height is too large of jump to be useful. Feet and inches reign supreme; not only is the inch a reasonable level of granularity between humans, we can also group the vast majority of adults into the five-foot-something range. Children are like, three or four feet tall, but they grow so fast that we get to use the phrase, "My gosh! You've grown a foot since I last saw you!" I don't know what they say in metric, but I guarantee it sounds ridiculous: "You must have grown 30 centimeters!?" I scoff at your obtuse phrasing. The metric system really is best for engineering scales—watches, ball bearings, engine parts—a larger domain, like interior architecture, generally benefits from base twelve or base sixteen measurement systems, where space can be more easily divided into halves, quarters, and eighths.
        <br/><br/>
