  ...
  renderEssay = () => {
    return (
      <div className="appear grid-break">
        <h3>
        As a continuation of <Link to='003'>my last essay</Link>, I hereby present <i>The Olympics of Weights and Measures</i>, where the world's remaining measurement systems compete for dominance on the world stage. The metric system is great for science and post-feudal taxation, but there are numerous contexts where the use of alternative units is a regular benefit! The <i>best</i> units are, in fact, context-dependent! What is really being compared, and why is that comparison valuable? How much does the system need to scale, and at what level of granularity, to be most convenient for users who need to communicate useful information quickly and efficiently? Today we talk about the best units—for humans.
        <br/><br/>
        ...
        <br/><br/>
        <b>Grams:</b> A drug dealer will make skillful use of the gram; however, he is adept at translating between imperial and metric with ease. He will often receive drugs in pounds or kilos from his own distributor, but use grams as the means of distribution. For some drugs, the gram has perfect granularity for human consumption. For others, like weed, an eighth-ounce is often ideal for moderate consumption over the course of a week.
        </h3>
      </div>
    )
  }
