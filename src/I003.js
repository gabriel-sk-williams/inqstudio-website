  ...
  renderEssay = () => {
    return (
      <div className="appear grid-break">
        ...
        <br/><br/>
        We weren't always blessed with the metric system: in fact, most of human history was plagued by <i>lesser</i> systems until the Enlightenment. One of the first prominent calls for global standardization came in 1783, from the British inventor James “The Steam Engine” Watt—who envisioned a new system, one “which might link the density of water to length and mass.” This was because Watt found collaboration with other civilized nations significantly more difficult without common units, especially those he could not easily replicate. He wasn't at all misguided: the people of pre-revolutionary France were using around eight hundred different measurement units,{this.super(2)} all with definitions that differed between municipalities. Without rigorous standardization, attempts at trans-national cooperation were very likely to lose something in translation.
        <br/><br/>
